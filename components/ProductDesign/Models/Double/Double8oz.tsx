...
type GLTFResult = GLTF & {
  nodes: {
    cup_double_8oz: THREE.Mesh;
    cup_double_8oz_1: THREE.Mesh;
    cup_double_8oz_2: THREE.Mesh;
  };
  materials: {
...
export function Double8oz(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/product-design/models/double/8oz.glb"
  ) as GLTFResult;
...
useGLTF.preload("/product-design/models/double/8oz.glb");
