...
export function V1Medium(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/product-design/models/plastic/v1_m.glb"
  ) as GLTFResult;
  ...
  useEffect(() => {
    store.handleCenterArrow = () => setXYZ([0, 0.065, 0.024]);
  }, []);
...
useGLTF.preload("/product-design/models/plastic/v1_m.glb");
