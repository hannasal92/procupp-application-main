...
export function V2Medium(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/product-design/models/plastic/v2_m.glb"
  ) as GLTFResult;
...
useGLTF.preload("/product-design/models/plastic/v2_m.glb");
